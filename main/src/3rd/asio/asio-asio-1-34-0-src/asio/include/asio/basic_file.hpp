...
public:
   ...
   * TcpServer 2003, and earlier versions of Windows, unless
   ...
   *
   * When running on Windows Vista, Windows TcpServer 2008, and later, the
  ...
  __declspec(deprecated("By default, this function always fails with "
        "operation_not_supported when used on Windows XP, Windows TcpServer 2003, "
